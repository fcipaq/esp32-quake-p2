...
#define DXQ3D9502_PAD_CONTROL     (0xB2)
#define DXQ3D9502_DSI_2_LANE      (0x10)
#define DXQ3D9502_DSI_4_LANE      (0x00)

#define DXQ3D9502_CMD_SHLR_BIT    (1ULL << 0)
#define DXQ3D9502_CMD_UPDN_BIT    (1ULL << 1)
#define DXQ3D9502_MDCTL_VALUE_DEFAULT   (0x01)
                                    ...
                                    esp_lcd_panel_handle_t *ret_panel)
{
    ...
    dxq3d9502->lane_num = vendor_config->mipi_config.lane_num;
    ...
    dxq3d9502->madctl_val = DXQ3D9502_MDCTL_VALUE_DEFAULT;
...
static esp_err_t panel_dxq3d9502_send_init_cmds(dxq3d9502_panel_t *dxq3d9502)
{
    ...
    uint8_t lane_command = DXQ3D9502_DSI_2_LANE;
    bool is_cmd_overwritten = false;

    switch (dxq3d9502->lane_num) {
    case 0:
    case 2:
        lane_command = DXQ3D9502_DSI_2_LANE;
        break;
    case 4:
        lane_command = DXQ3D9502_DSI_4_LANE;
        break;
    default:
        ESP_LOGE(TAG, "Invalid lane number %d", dxq3d9502->lane_num);
        return ESP_ERR_INVALID_ARG;
    }
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, DXQ3D9502_PAD_CONTROL, (uint8_t[]) {
        lane_command,
    ...
    for (int i = 0; i < init_cmds_size; i++) {
        ...
        if (init_cmds[i].data_bytes > 0) {
            ...
            case LCD_CMD_MADCTL:
                ...
                dxq3d9502->madctl_val = ((uint8_t *)init_cmds[i].data)[0];
                break;
            default:
...
static esp_err_t panel_dxq3d9502_mirror(esp_lcd_panel_t *panel, bool mirror_x, bool mirror_y)
{
    dxq3d9502_panel_t *dxq3d9502 = (dxq3d9502_panel_t *)panel->user_data;
    esp_lcd_panel_io_handle_t io = dxq3d9502->io;
    uint8_t madctl_val = dxq3d9502->madctl_val;
    ...
    dxq3d9502->madctl_val = madctl_val;
